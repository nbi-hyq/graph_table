...
### code from https://github.com/nbi-hyq/FusionGraphTransformer with local Clifford gates
...
def measure_single_with_clifford(g, node, pauli, method=0, sp=-1, rnd=False):
...
def measure_double_parity_with_clifford(g, node1, node2, parity):
